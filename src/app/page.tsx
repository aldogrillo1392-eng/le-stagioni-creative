        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
          {CATEGORY_OPTIONS.filter(c => c.value !== 'all').map(cat => (
            <Link
              ...
              className="group flex flex-col items-center gap-2 p-3 bg-white rounded-2xl hover:shadow-card-hover hover:-translate-y-0.5 transition-all duration-200 text-center overflow-hidden"
            >
              <div className="relative w-full aspect-square rounded-xl overflow-hidden">
                <Image
                  src={`/images/categorie/${cat.value}.jpg`}
                  alt={cat.label}
                  fill
